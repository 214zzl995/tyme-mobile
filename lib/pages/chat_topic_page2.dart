...
class ChatTopicPage2 extends StatefulWidget {
  const ChatTopicPage2({Key? key, required this.topic}) : super(key: key);

  final SubscribeTopic topic;

  @override
  State<ChatTopicPage2> createState() => _ChatTopicPage2State();
}

class _ChatTopicPage2State extends State<ChatTopicPage2> {
  ...
  late Stream<List<(int, ChatMessage)>> messageStream =
      context.read<Clint>().messagesByTopicStream(widget.topic, initialData: initialData);
              ...
              child: EasyRefresh(
                ...
                onLoad: () {
                  return Future.delayed(const Duration(seconds: 2), () {
                    ...
                    // 通过Stream推送更早的数据
                    // messageStream.startWith(topicReadIndex.moreData);
  ...
  Widget _buildMessageList(BuildContext context) {
    return StreamProvider<List<(int, ChatMessage)>>(
      ...
      create: (BuildContext context) => messageStream,
